...
angular.module('genTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('superSubAccount.html', '<div class="panel panel-default"><div class="panel-heading"><p class="panel-title"><button class="btn btn-default" ng-click="showAddSubAccountModal()" data-toggle="modal" data-target="#addSubAccountPanel"><span class="glyphicon glyphicon-plus"></span>&nbsp;新增子账户</button></p></div><table class="table table-bordered table-hover" ng-if="subAccounts.length !== 0"><tr class="tableTitle"><td>编号</td><td>用户名称</td><td>用户邮箱</td><td>用户电话</td><td>开发者id</td><td>操作</td></tr><tr ng-repeat="account in subAccounts"><td>{{$index +1}}</td><td>{{account.contacts}}</td><td>{{account.login_id}}</td><td>{{account.telephone}}</td><td>{{account.pubid}}</td><td class="td_width200"><a class="glyphicon glyphicon-edit cursor_p" ng-click="showEditSubAccountModal(account)" data-toggle="modal" data-target="#editSubAccountPanel">编辑</a>&nbsp;&nbsp; <a class="glyphicon glyphicon-edit cursor_p" ng-click="delSubAccount($index)">删除</a>&nbsp;&nbsp;</td></tr></table></div><p class="nothing" ng-if="subAccounts.length === 0">暂无数据信息</p><div class="modal fade" id="editSubAccountPanel"><div class="modal-content modal-dialog"><div class="modal-header"><p><a class="close" data-dismiss="modal">×</a></p>超级管理员子账户权限设置</div><div class="modal-body clearfix"><div class="form-group clearfix"><label class="col-sm-2 control-label text-right" style="padding:0;">账号：</label><div class="col-sm-10"><input type="text" class="form-control" disabled ng-model="subAccount.login_id"></div></div><div><div><p>功能模块权限设置</p><span style="font-size: 20px">参数管理：</span> <input type="checkbox" ng-model="accountJurisdiction.para_ctrl">控制参数 <input type="checkbox" ng-model="accountJurisdiction.para_inject">注入参数<br><span style="font-size: 20px">投放管理：</span> <input type="checkbox" ng-model="accountJurisdiction.view_strategy">查看投放策略 <input type="checkbox" ng-model="accountJurisdiction.new_strategy">新增投放策略<br><span style="font-size: 20px">任务管理：</span> <input type="checkbox" ng-model="accountJurisdiction.view_task">查看任务组 <input type="checkbox" ng-model="accountJurisdiction.new_task">新增任务组<br><span style="font-size: 20px">应用管理：</span> <input type="checkbox" ng-model="accountJurisdiction.app_ctrl">应用管理<br><span style="font-size: 20px">广告管理：</span> <input type="checkbox" ng-model="accountJurisdiction.view_adstrategy">查看广告策略 <input type="checkbox" ng-model="accountJurisdiction.new_adstrategy">新增广告策略<br><span style="font-size: 20px">用户管理：</span> <input type="checkbox" ng-model="accountJurisdiction.user_ctrl">用户管理<br><span style="font-size: 20px">资源管理：</span> <input type="checkbox" ng-model="accountJurisdiction.view_resource">查看资源 <input type="checkbox" ng-model="accountJurisdiction.upload_resource">上传资源<br><span style="font-size: 20px">统计管理：</span> <input type="checkbox" ng-model="accountJurisdiction.statistics_ctrl">统计分析<br><span style="font-size: 20px">区域管理：</span> <input type="checkbox" ng-model="accountJurisdiction.area_ctrl">区域管理<br><span style="font-size: 20px">发布管理：</span> <input type="checkbox" ng-model="accountJurisdiction.publish_application">发布应用<br><span style="font-size: 20px">标签管理：</span> <input type="checkbox" ng-model="accountJurisdiction.new_tag">新增标签 <input type="checkbox" ng-model="accountJurisdiction.view_tag">查看标签<br></div></div></div><div class="modal-footer"><button class="btn btn-info" ng-click="updateSubAccountJurisdiction()">保&nbsp;&nbsp;存</button></div></div></div><div class="modal fade" id="addSubAccountPanel"><div class="modal-content modal-dialog"><div class="modal-header"><p><a class="close" data-dismiss="modal">×</a></p>超级管理员子账户权限设置</div><div class="modal-body clearfix"><div class="form-group row"><label class="col-sm-2 text-right">用户邮箱:</label><div class="col-sm-9"><input class="form-control" type="email" placeholder="邮箱ID" name="loginId" ng-model="subAccount.login_id" data-valid-name="邮箱" ui-validate="{pattern:checkEmail}" gen-tooltip="validateTooltip"></div></div><div class="form-group row"><label class="col-sm-2 text-right">用户密码:</label><div class="col-sm-9"><input class="form-control" type="password" placeholder="输入6-15位密码" data-valid-name="密码" ng-model="subAccount.password" ng-minlength="6" ng-maxlength="20" gen-tooltip="validateTooltip" required></div></div><div class="form-group row"><label class="col-sm-2 text-right">确认密码:</label><div class="col-sm-9"><input class="form-control" type="password" placeholder="确认密码" data-valid-name="密码" ng-model="subAccount.password2" ui-validate="{repasswd:\'$value==subAccount.password\'}" ui-validate-watch="\'subAccount.password\'" gen-tooltip="validateTooltip"></div></div><div class="form-group row"><label class="col-sm-2 text-right">用户昵称:</label><div class="col-sm-9"><input class="form-control" type="text" placeholder="用户昵称" data-valid-name="联系人" ng-model="subAccount.contacts" gen-tooltip="validateTooltip" required></div></div><div class="form-group row"><label class="col-sm-2 text-right">电话号码:</label><div class="col-sm-9"><input class="form-control" type="text" placeholder="输入有效电话" data-valid-name="电话" ui-validate="{pattern:checkTel}" ng-model="subAccount.telephone" gen-tooltip="validateTooltip"></div></div><div><div><p>功能模块权限设置</p><span style="font-size: 20px">参数管理：</span> <input type="checkbox" ng-model="accountJurisdiction.para_ctrl">控制参数 <input type="checkbox" ng-model="accountJurisdiction.para_inject">注入参数<br><span style="font-size: 20px">投放管理：</span> <input type="checkbox" ng-model="accountJurisdiction.view_strategy">查看投放策略 <input type="checkbox" ng-model="accountJurisdiction.new_strategy">新增投放策略<br><span style="font-size: 20px">任务管理：</span> <input type="checkbox" ng-model="accountJurisdiction.view_task">查看任务组 <input type="checkbox" ng-model="accountJurisdiction.new_task">新增任务组<br><span style="font-size: 20px">应用管理：</span> <input type="checkbox" ng-model="accountJurisdiction.app_ctrl">应用管理<br><span style="font-size: 20px">广告管理：</span> <input type="checkbox" ng-model="accountJurisdiction.view_adstrategy">查看广告策略 <input type="checkbox" ng-model="accountJurisdiction.new_adstrategy">新增广告策略<br><span style="font-size: 20px">用户管理：</span> <input type="checkbox" ng-model="accountJurisdiction.user_ctrl">用户管理<br><span style="font-size: 20px">资源管理：</span> <input type="checkbox" ng-model="accountJurisdiction.view_resource">查看资源 <input type="checkbox" ng-model="accountJurisdiction.upload_resource">上传资源<br><span style="font-size: 20px">统计管理：</span> <input type="checkbox" ng-model="accountJurisdiction.statistics_ctrl">统计分析<br><span style="font-size: 20px">区域管理：</span> <input type="checkbox" ng-model="accountJurisdiction.area_ctrl">区域管理<br><span style="font-size: 20px">发布管理：</span> <input type="checkbox" ng-model="accountJurisdiction.publish_application">发布应用<br><span style="font-size: 20px">标签管理：</span> <input type="checkbox" ng-model="accountJurisdiction.new_tag">新增标签 <input type="checkbox" ng-model="accountJurisdiction.view_tag">查看标签<br></div></div></div><div class="modal-footer"><button class="btn btn-info" ng-click="addSubAccount()">保&nbsp;&nbsp;存</button></div></div></div>');

  $templateCache.put('syscode.html', '<div class="panel panel-default syscode"><div class="panel-body"><div class="col-sm-8 border_r"><h3 class="form-group">系统编码</h3><h4>注入条件</h4><ol><li>注入条件由零到多个维度组成</li><li>每个维度的key与value之间使用冒号分隔，例如：geo_in:cn,tw,hk,sg,mo 表示大中华区</li><li>各维度之间是and的关系，使用两个$符号进行分隔，例如：geo_in:us,jp$$time_in:8-20，表示需要满足在美国或是日本，并且时间范围是从早上8点到晚上20点之间这个时间范围内</li><li>每个维度在key后边必须增加<strong>_in</strong>表示当满足这个条件时为真，每个维度在字段后边增加<strong>_out</strong>表示当不满足这个条件为真</li><li>除<em>ad_family</em>这个维度以外，所有其他维度key后边，都需要增加<strong>_in</strong>或者是<strong>_out</strong></li><li>维度的值，多个值之间使用逗号进行分隔；例如操作系统版本：oscode_out:9,10,11</li><li>维度的值，如果是一个范围，则可以使用-来进行表示，例如：time_out:0-6，表示在0点到6点这个时间段以外，复杂的表示：oscode_in:9-18,22,23表示过滤掉19，20，21这个三个版本，另外需要需要的是范围是包括边界的，例如日期：data_in:20160101-20160630，这个表达式是包含元月前日和6月30日两个日期的</li><li>后面不需要加<strong>_in</strong>或者是<strong>_out</strong>的维度,名称中有且仅有有一个<strong>_</strong>,如:ad_family</li><li>后面需要加<strong>_in</strong>或者是<strong>_out</strong>的维度,名称中不能有<strong>_</strong>,如:geo</li><li>如果条件表达式在写法上出现问题，将会被表达式引擎忽略</li></ol><h4>支持的维度</h4><ol><li><strong>geo</strong> 指国家或地区，使用国际标准的代码以及自定义的组合代码，具体代码参考地区代码表</li><li><strong>areacode</strong> 当geo_in:cn的时候，该区域代表地市的编码，如深圳的areacode_in:440300</li><li><strong>resolution</strong> 频率分辨率 resolution_in:240x320</li><li><strong>oscode</strong> 操作系统版本，android以整数数字为标准，其他系统以实际系统版本为准，如ios可能是9.3.2 oscode_in:9.3.2,9.3.1</li><li><strong>vcode</strong> 应用版本代码，如 707087，可以作为一个整数范围来理解，其他平台的应用版本建议也转化为长整形处理</li><li><strong>sdkcode</strong> sdk版本代码，如：sdkcode_in:1000</li><li><strong>time</strong> 时间范围，以手机所在地时间为准，time_in:0-6,22-24</li><li><strong>date</strong> 日期范围， (date_in:20150105-20150709)</li><li><strong>net</strong> 网络类型，（net_in:wifi）</li><li><strong>adtype</strong> 广告类型 （adtype_in:interstitial）</li><li><strong>page</strong> 页面类型 page_in:splash</li><li><strong>entry</strong> 入口类型：entry_in: 自定义</li><li><strong>market</strong> market_in:googleplay,9apps[市场直接填写名称，名称由系统统一定义]</li><li><strong>ad_family</strong> 广告是否增加family参数 0 为增加 1为不增加</li><li><strong>language</strong> 语言（中文统一按照zh来处理） language_in:in;</li><li><strong>devicetype</strong> 设备类型 devicetype_in: 0（不限）1（手机）2（平板）</li><li><strong>usergroup</strong> 用户类型 usergroup_in （<em>未来扩展</em>）</li><li><strong>category</strong> 当前应用分类（<em>未来扩展</em>）</li><li><strong>tag</strong> 当前应用的标签：tag_in: match_3,girl（<em>未来扩展</em>）</li><li><strong>vtime</strong> 版本安装时间：vtime_in:0-300</li><li><strong>level</strong> 游戏的关卡数：level_in: 0-3</li><li><strong>icon_template</strong> icon的action流程控制,是插屏还是直接跳市场</li><li><strong>cross_filter</strong> 控制跨账户推广</li></ol><h4>具体例子</h4><pre><code>例子1:geo_in:us$$vcode_in:7101$$date_in:20160612-20160620$$time_in:8-19 <br>例子2:geo_in:cn$$areacode_in:440300$$oscode_in:21$$time_in:9-18\n                    </code></pre></div><div class="col-sm-4 border_r"><h3>广告类型编码</h3><ol><li><strong>interstitial</strong> 插屏</li><li><strong>banner</strong> banner条</li><li><strong>video</strong> 视频</li><li><strong>native</strong> 原生</li><li><strong>offer</strong> 积分墙</li><li><strong>more</strong> 市场</li><li><strong>icon</strong> icon</li></ol><h3>应用页面编码</h3><ol><li><strong>home</strong> 首页（launch）</li><li><strong>main</strong> 内容页面（游戏：过关等）</li><li><strong>pause</strong> 暂停</li><li><strong>exit</strong> 退出</li><li><strong>switchin</strong> 从桌面切入到应用内</li><li><strong>appout</strong> 应用外部</li></ol></div></div></div>');

  $templateCache.put('taskInfo.html', '<div class="panel panel-default form-group"><div class="panel-body" ng-if="tasks.length !== 0"><table class="table table-bordered table-hover"><tr class="tableTitle"><td class="td_width200">任务组描述</td><td>应用组</td><td>开关switch</td><td>更新时间</td><td class="td_width200">操作</td></tr><tr ng-repeat="task in tasks"><td class="td_width200">{{task.describe}}</td><td>{{task.linkids}}</td><td ng-if="task.switch === \'1\'">开启</td><td ng-if="task.switch === \'0\'">关闭</td><td ng-if="task.switch === undefined"></td><td>{{task.utime}}</td><td class="td_width200"><a ui-sref="task.taskModify({optgroupid : task._id.$oid})" class="glyphicon glyphicon-edit">编辑任务</a>&nbsp;&nbsp; <a href class="glyphicon glyphicon-remove" ng-click="delTask(task._id.$oid, $index)">删除</a>&nbsp;&nbsp; <a href data-target="#addProperty" data-toggle="modal" ng-click="addProperty(task,$index)" class="glyphicon glyphicon-edit">编辑属性</a></td></tr></table></div></div><div class="modal fade" id="addProperty"><div class="modal-content modal-dialog"><div class="modal-header"><p><a class="close" data-dismiss="modal">×</a></p>增加属性</div><div class="modal-body clearfix"><div ng-jsoneditor ng-model="property" options="options"></div></div><div class="modal-footer"><button class="btn btn-info" ng-click="updateProperty()">保&nbsp;&nbsp;存</button></div></div></div><p class="nothing" ng-if="tasks.length == 0">暂无数据信息</p><nav class="text-right" gen-pagination="pagination"></nav>');

  $templateCache.put('taskInsert.html', '<div ng-jsoneditor ng-model="data" options="options" class="jsontxt"></div><div class="form-group" style="position: relative"><ng-file-input mode="text" callback="callback(file)" class="ng-file-input"></ng-file-input><button class="btn btn-info btn-s" style="position: absolute; top: -4px;" ng-click="submit()">保&nbsp;&nbsp;存</button> <button class="btn btn-info btn-s" style="position: absolute; top: -4px; left: 220px;" data-toggle="modal" data-target="#fullpage">全&nbsp;&nbsp;屏</button></div><br>JSON文件格式参考：{"describe" : "描述" , "switch" : "开关" , "condition" : "条件" , "tasks" : [ { 任务节点1 } , { 任务节点2 }...] }<div class="bg-danger clearfix panel-body" ng-if="errors.length != 0"><p style="text-indent: 10px;" class="text-danger" ng-repeat="error in errors">error : {{error.error}}</p></div><div class="modal fade height100" id="fullpage"><div class="modal-content height100"><div class="modal-body height100"><div ng-jsoneditor ng-model="data" options="options" class="jsontxt height100"></div></div><button class="btn btn-info returnJson" data-dismiss="modal">返&nbsp;&nbsp;回</button></div></div>');

  $templateCache.put('taskModify.html', '<div class="form-group"><div class="panel-heading"><p class="panel-title"><button class="btn btn-default" data-toggle="modal" data-target="#addTask"><span class="glyphicon glyphicon-plus"></span>&nbsp;新增任务子节点</button></p></div><div class="panel-body" ng-if="task.length !== 0"><table class="table table-bordered table-hover"><tr class="tableTitle"><td class="td_width200">id</td><td>name</td><td>weight</td><td class="td_width200">操作</td></tr><tr ng-repeat="t in task track by $index"><td class="td_width200">{{t.id}}</td><td>{{t.name}}</td><td>{{t.weight}}</td><td class="td_width200"><a href data-target="#taskModify" data-toggle="modal" ng-click="modifyTask(t,$index)" class="glyphicon glyphicon-edit">编辑</a>&nbsp;&nbsp; <a href class="glyphicon glyphicon-remove" ng-click="delTask(t,$index)">删除</a>&nbsp;&nbsp;</td></tr></table></div><p class="nothing" ng-if="task.length == 0">暂无数据信息</p><br><div ng-if="user.pub_level !== \'0\'"><p>选择应用组<span class="glyphicon glyphicon-info-sign cursor_p" title="任务将会在与之关联的应用组所包含的应用中投放"></span></p><p><span ng-repeat="linkid in linkids"><input type="checkbox" ng-checked="linkid.checked" ng-click="selectLinkid($index)">{{linkid.linkid}}&nbsp;</span></p></div><button class="btn btn-info" ng-click="submit()">保&nbsp;&nbsp;存</button> <button class="btn btn-info btn-s" data-toggle="modal" data-target="#fullpage">全&nbsp;&nbsp;屏</button></div><div class="modal fade height100" id="fullpage"><div class="modal-content height100"><div class="modal-body height100"><div ng-jsoneditor ng-model="task" options="options" class="height100"></div></div><button class="btn btn-info returnJson" data-dismiss="modal">保&nbsp;&nbsp;存</button></div></div><div class="bg-danger clearfix panel-body" ng-if="errors.length != 0"><p style="text-indent: 10px;" class="text-danger" ng-repeat="error in errors">error : {{error.error}}</p></div><div class="modal fade" id="taskModify"><div class="modal-content modal-dialog"><div class="modal-header"><p><a class="close" data-dismiss="modal">×</a></p>编辑任务</div><div class="modal-body clearfix"><div ng-jsoneditor ng-model="subtask" options="options"></div></div><div class="modal-footer"><button class="btn btn-info" ng-click="updateTask()">保&nbsp;&nbsp;存</button></div></div></div><div class="modal fade" id="addTask"><div class="modal-content modal-dialog"><div class="modal-header"><p><a class="close" data-dismiss="modal">×</a></p>增加任务（请增加单个任务子节点）</div><div class="modal-body clearfix"><div ng-jsoneditor ng-model="subtaskdata" options="options"></div></div><div class="modal-footer"><button class="btn btn-info" ng-click="addTask()">保&nbsp;&nbsp;存</button></div></div></div>');

  $templateCache.put('testApp.html', '<div class="panel panel-default"><div class="panel-heading"><p class="panel-title"><button class="btn btn-default" ng-click="showAddAppTestIdModal()" data-toggle="modal" data-target="#testIdPanel"><span class="glyphicon glyphicon-plus"></span>&nbsp;新增id</button></p></div><table class="table table-bordered table-hover" ng-if="appTestIds.length !== 0"><tr class="tableTitle"><td class="td_width200">测试id描述</td><td class="td_width80">switch</td><td>测试id</td><td class="td_width120">ctrl</td></tr><tr ng-repeat="apptest in appTestIds"><td class="td_width200">{{apptest.desc}}</td><td class="td_width80">{{apptest.switch}}</td><td>{{apptest.id}}</td><td class="td_width120"><a class="glyphicon glyphicon-edit cursor_p" ng-click="showEditAppTestIdModal(apptest)" data-toggle="modal" data-target="#testIdPanel">编辑</a>&nbsp;&nbsp; <a class="glyphicon glyphicon-edit cursor_p" ng-click="delAppTestId($index)">删除</a>&nbsp;&nbsp;</td></tr></table></div><p class="nothing" ng-if="appTestIds.length === 0">暂无数据信息</p><div class="modal fade" id="testIdPanel"><div class="modal-content modal-dialog"><div class="modal-header"><p><a class="close" data-dismiss="modal">×</a></p></div><div class="modal-body clearfix"><div class="form-group clearfix"><label class="col-sm-2 control-label text-right" style="padding:0;">id描述：</label><div class="col-sm-10"><input type="text" class="form-control" ng-model="appTest.desc"></div></div><div class="form-group clearfix"><label class="col-sm-2 control-label text-right" style="padding:0;">开关项：</label><div class="col-sm-10"><input type="text" class="form-control" placeholder="0 or 1" ng-model="appTest.switch"></div></div><div class="clearfix"><label class="col-sm-2 control-label text-right" style="padding:0;">id：</label><div class="col-sm-10"><input type="text" class="form-control" ng-model="appTest.id"></div></div></div><div class="modal-footer"><button ng-if="isAddFalg" class="btn btn-info" ng-click="addAppTestId()">保&nbsp;&nbsp;存</button> <button ng-if="!isAddFalg" class="btn btn-info" ng-click="changeAppTestId()">保&nbsp;&nbsp;存</button></div></div></div>');

  $templateCache.put('testAppPub.html', '<span ng-if="upload">预计发布所需时间:2分钟,请耐心等待后测试!</span><div class="panel-group" id="accordions"><div class="panel panel-default"><div class="panel-heading clearfix"><select class="cursor_p searchInput pull-right" ng-model="search.linkid" ng-options="linkid.linkid as linkid.linkid for linkid in linkids"><option value>--全部分组--</option></select><select class="cursor_p searchInput pull-right" ng-model="search.mark" style="width: 150px;color: #686868"><option value>--全部标记--</option><option value="1" style="background: red;">--红色--</option><option value="2" style="background: orange">--橙色--</option><option value="3" style="background: yellow">--黄色--</option><option value="4" style="background: green">--绿色--</option><option value="5" style="background: cyan">--青色--</option><option value="6" style="background: blue">--蓝色--</option><option value="7" style="background: purple">--紫色--</option></select></div><div class="panel-body" ng-if="apps.length !== 0"><table class="table table-bordered table-hover"><tr class="tableTitle"><td>ICON</td><td>应用名称</td><td>APPKEY</td><td>应用分组</td><td>操作</td></tr><tr ng-repeat="app in appList" class="listCont"><td><img ngf-src="app.icon||\'img/100991_icon_01.png\'"></td><td ng-if="app.mark === undefined || app.mark === null || app.mark === \'0\'">{{app.name}}</td><td ng-if="app.mark !== undefined && app.mark !== null && app.mark !== \'0\'" class="mark-{{app.mark}}">{{app.name}}</td><td>{{app.appkey}}</td><td>{{app.linkid}}</td><td class="cursor_p"><input type="checkbox" ng-checked="app.isSelect" ng-click="selectApp($index)">&nbsp;&nbsp;勾选&nbsp;&nbsp;</td></tr></table><div class="form-group"><input type="checkbox" ng-checked="isSelectLinkid" ng-click="selectLinkid()" class="cursor_p">&nbsp;&nbsp;发布当前的分组应用</div><div class="clearfix"><button class="btn btn-info" data-target="#appSyn" ng-click="showModal()" data-toggle="modal">发&nbsp;&nbsp;布</button> <button class="btn btn-info" ng-if="upload" ng-click="newSynInfo()">刷新发布信息</button></div></div></div><nav class="text-right" gen-pagination="pagination"></nav><p class="nothing" ng-if="apps.length == 0">暂无数据信息</p><div class="modal fade" id="appSyn"><div class="modal-content modal-dialog"><div class="modal-header"><p><a class="close" data-dismiss="modal">×</a></p></div><div class="modal-body"><div class="clearfix form-group"><label class="col-sm-3 control-label text-right">发布原因：</label><div class="col-sm-8"><textarea rows="8" class="form-control" ng-model="reason"></textarea></div></div><div ng-if="errorShow" ng-repeat="error in errors"><p class="text-center">{{error.error}}</p></div></div><div class="modal-footer"><button class="btn btn-info" ng-click="syn()">确&nbsp;&nbsp;定</button></div></div></div></div>');
